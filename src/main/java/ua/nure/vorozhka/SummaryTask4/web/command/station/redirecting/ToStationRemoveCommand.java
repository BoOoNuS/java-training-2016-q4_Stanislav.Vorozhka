 ...
 */
public class ToStationRemoveCommand extends Command {

    private static final Logger LOG = Logger.getLogger(ToStationRemoveCommand.class);
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        return Paths.REMOVE_STATION_CONFIRMATION_PAGE;
    }
}
