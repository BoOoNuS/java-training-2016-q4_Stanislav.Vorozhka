...
<c:if test="${sessionScope.user.role.name=='admin'}">
    ...
    <table><br/>
        <tr>
            <td><fmt:message key="page.lang.sure.delete.route" />?</td>
        </tr>
        <tr>
            <td><fmt:message key="page.lang.if.delete.route.warning" /></td>
        </tr>
    </table>
    ...
    <table><br/>
        <tr>
            <form action="/controller" method="post">
                <input type="hidden" name="command" value="removeRoute">
